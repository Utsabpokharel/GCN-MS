            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form action="{{route('expense.update',$expense->id)}}" id="form_sample_1" class="form-horizontal" method="post" autocomplete="on"
                            ...
                            <div class="form-body">
                                <div class="form-group row">
									...
									<div class="col-md-5">
                    					<input type="date" class="form-control input-height @error('expdate') is-invalid @enderror" 
                                        data-date-format="yyyy-mm-dd" value="{{$expense->expdate}}" />
										@error('expdate')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="particular" required placeholder="Enter Particular"
                                            class="form-control input-height " value="{{$expense->particular}}" />
                                    </div>
                                </div>
                                <div class="form-group row">
									...
									<div class="col-md-5">
                                        ...
                                        required placeholder="Enter Amount" value="{{$expense->amount}}" />
										@error('amount')
										<span class="invalid-feedback" role="alert">
										    <strong>{{$message}}</strong>
										</span>
                                ...
                                <div class="form-group row">
									...
									<div class="col-md-5">
                                    <select name="payment" class="form-control input-height @error('payment') is-invalid @enderror"  value="{{$expense->payment}}">
