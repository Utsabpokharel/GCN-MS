            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form action="{{route('enquirycategory.update',$enquirycategory->id)}}" id="form_sample_1" class="form-horizontal" method="post" autocomplete="on"
                            ...
                            <div class="form-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="name" required placeholder="Category Name"
                                            class="form-control input-height" value="{{$enquirycategory->name}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        class="form-control" value="{{$enquirycategory->description}}"></textarea>
                                    </div>
