						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								...
								<div class="card-body" id="bar-parent">
									<form action="{{route('services.update',$services->id)}}" id="form_sample_1" class="form-horizontal" method="post" autocomplete="on"  enctype="multipart/form-data">
										{{csrf_field()}}
										@method('PUT')
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('name') is-invalid @enderror" value="{{$services->name}}" />
													@error('name')
											...
											<div class="form-group row">
												...
												<div class="col-md-5">													
													...
													class="form-control input-height @error('price') is-invalid @enderror" value="{{$services->price}}" />
													@error('price')
														<span class="invalid-feedback" role="alert">
															<strong>{{$message}}</strong>
														</span>
											...
											<div class="form-group row">
                                        		...
                                        		placeholder="Enter Description" value="{{$services->description}}"></textarea>
            										@error('description')
                										<span class="invalid-feedback" role="alert">
															<strong>{{$message}}</strong>
														</span>
											...
											<div class="col-md-5">
          										<select name="status"  class="form-control form-control-solid @error('status') is-invalid @enderror" value="{{$services->status}}">
