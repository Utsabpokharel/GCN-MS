										...
										<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('lname') is-invalid @enderror" value="{{$customer->lname}}" />
													@error('lname')
														<span class="invalid-feedback" role="alert">
															<strong>{{$message}}</strong>
														</span>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">													
													...
													class="form-control input-height @error('email') is-invalid @enderror" value="{{$customer->email}}" />
													@error('email')
														<span class="invalid-feedback" role="alert">
															<strong>{{$message}}</strong>
														</span>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('mobile') is-invalid @enderror" value="{{$customer->mobile}}"/>
                                                   	@error('mobile')
                    								<span class="invalid-feedback" role="alert">
														<strong>{{$message}}</strong>
													</span>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('phone') is-invalid @enderror" value="{{$customer->phone}}"/>
                                                   	@error('phone')
                    								<span class="invalid-feedback" role="alert">
														<strong>{{$message}}</strong>
													</span>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('city') is-invalid @enderror" value="{{$customer->city}}">
													@error('city')
                    								<span class="invalid-feedback" role="alert"> 
														<strong>{{$message}}</strong>
													</span>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('district') is-invalid @enderror" value="{{$customer->district}}">
                    								@error('district')
                    								<span class="invalid-feedback" role="alert"> 
														<strong>{{$message}}</strong>
													</span>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('permanent_address') is-invalid @enderror" value="{{$customer->permanent_address}}">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													...
													class="form-control input-height @error('temporary_address') is-invalid @enderror" value="{{$customer->temporary_address}}">
